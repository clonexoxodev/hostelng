-- ============================================
-- STUDENT INQUIRY SYSTEM - DATABASE SCHEMA
...
CREATE TABLE IF NOT EXISTS public.student_inquiries (
    ...
    -- Duplicate prevention: same email + hostel within 24h
...
SELECT 'Student inquiries table created successfully' as status;
